...
<template>
  ...
  <nav class="flex justify-between items-center bg-orange-400 p-4">
    <div class="max-w-screen-xl flex flex-wrap items-center md:flex-row md:flex-nowrap justify-center  mx-auto gap-3 md:gap-5  p-4">
      <div class="mx-auto">
      ...
      <span class="block self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Smakoowa </span>
        ...
        <div class="flex md:order-2 mx-auto gap-2" >
          ...
          <button v-if="user.isLogged==true" @click="$router.push('/logout')" type="button" class="text-white   focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 bg-orange-600 hover:bg-orange-700 focus:ring-orange-800">Logout</button>
        ...
        <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" v-bind:class="{'hidden': isMenuVisible}"  id="navbar-sticky">
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border justify-center bg-orange-200 md:bg-orange-400 rounded-lg w-full md:flex-row md:space-x-8 md:mt-0 md:border-0  ">      
            <li>
              <router-link to="/search" href="#" class="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-700 md:p-0 md:dark:hover:text-white-500 ">Search</router-link>
            </li>
            <li>
            <router-link to="/categories" class="block py-2 pl-3 pr-4 text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-700 md:p-0 md:dark:hover:text-white-500 ">Categories</router-link>
            </li>
            <li>
            <router-link to="/tags" class="block py-2 pl-3 pr-4  text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-700 md:p-0 md:dark:hover:text-white-500 ">Tags</router-link>
            </li>
            <li>
              <router-link to="/about" class="block py-2 pl-3 pr-4 rounded text-white hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-700 md:p-0 md:dark:hover:text-white-500 ">About Us</router-link>
            </li>
          </ul>
        </div>
    </div>
