...
<template>
  ...
  <nav class="flex justify-between items-center bg-orange-400 p-4">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between  mx-auto gap-3 md:gap-4  p-4">
      ...
      <img src="./assets/logoSmakoowa.png" class="h-8 mr-3" alt="Flowbite Logo">
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Smakoowa </span>
      </a>
        <div class="flex md:order-2" >
          <button v-if="user.isLogged==false" @click="goToLogin" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">Log in</button>
          <button v-if="user.isLogged==false" @click="goToRegister" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">Register</button>
          <button v-if="user.isLogged==true" @click="goToProfile" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">Profile</button>
        ...
        <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" v-bind:class="{'hidden': isMenuVisible}"  id="navbar-sticky">
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 w-100 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-200 md:dark:bg-orange-400 dark:border-orange-700">
            <li>
              <router-link to="/" class="block py-2 pl-3 pr-4 text-white rounded md:bg-transparent md:text-white-700 md:p-0 dark:hover:bg-orange-700 md:dark:text-white-500" aria-current="page">Home</router-link>
            </li>
            <li>
              <router-link to="/recipes" href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-700 md:p-0 md:dark:hover:text-white-500 dark:text-white dark:hover:bg-orange-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Recipes</router-link>
            </li>
            <li>
            ...
            <li>
              <button v-if="user.isLogged==true"  @click="logout" href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-700 md:p-0 md:dark:hover:text-white-500 dark:text-white dark:hover:bg-orange-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Logout</button>
            </li>
          </ul>
        </div>
        </div>
