<template>
  <div
    v-if="show"
    class="flex items-center w-full my-2 p-4 bg-orange-300 rounded-lg"
  >
    ...
    <div class="flex items-center ml-auto space-x-2">
      ...
      <p class="text-sm font-small text-black p-1.5 rounded-lg">
        {{ getCategoryNameById(categoryId).name }}
      </p>
      <button
        type="button"
        @click="pushToPage(id)"
        class="bg-orange-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 h-8"
      >
        Visit
      </button>
      <button
        type="button"
        @click="editPage(id)"
        class="bg-orange-500 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 h-8"
      >
        Edit
      </button>
      <button
        type="button"
        @click="deleteUserRecipe(id)"
        class="bg-orange-600 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 h-8"
      >
        Delete
      </button>
    </div>
